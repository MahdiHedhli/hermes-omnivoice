...
Status as of 2026-05-30 21:00 America/New_York on branch
...
- `scripts/validate-omnivoice-bridge.sh`: PASS, 84 tests with 1 expected
...
- Repo artifact scan: PASS, no generated audio, model weights, env files, or
  local voice selection state found in the repo. This check is now enforced by
