...
if [[ -z "${HERMES_OMNIVOICE_COMMAND_JSON:-}${HERMES_OMNIVOICE_COMMAND:-}${HERMES_OMNIVOICE_STUDIO_URL:-}${HERMES_OMNIVOICE_AUTO_CLI:-}" ]]; then
  echo "SKIP: set HERMES_OMNIVOICE_STUDIO_URL, HERMES_OMNIVOICE_COMMAND_JSON, HERMES_OMNIVOICE_COMMAND, or HERMES_OMNIVOICE_AUTO_CLI=1 to run the OmniVoice smoke test" >&2
  exit 77
fi
